      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          <div className="md:col-span-5">
            ...
            <div className="flex space-x-5 animate-fade-up" style={{ animationDelay: "0.2s" }}>
              <a href="#" className="w-10 h-10 rounded-full bg-hackathon-almond/10 flex items-center justify-center hover:bg-hackathon-almond/20 transition-colors hover:-translate-y-1 duration-300">
          ...
          <div className="md:col-span-3">
            <h4 className="font-display text-xl font-semibold mb-6 animate-fade-up">Quick Links</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name} className="animate-fade-up" style={{ animationDelay: `${0.1 + index * 0.05}s` }}>
                  <Link 
                    to={link.path} 
                    className="inline-flex items-center text-hackathon-almond/70 hover:text-hackathon-almond transition-colors group"
                  >
                    <ChevronRight size={16} className="mr-2 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1 duration-300" />
                    <span>{link.name}</span>
                  </Link>
                </li>
              ))}
          ...
          <div className="md:col-span-4">
            <h4 className="font-display text-xl font-semibold mb-6 animate-fade-up">Contact Us</h4>
            <div className="space-y-4">
              <div className="flex items-start space-x-3 animate-fade-up" style={{ animationDelay: "0.1s" }}>
                ...
                <span className="text-hackathon-almond/80 hover:text-hackathon-almond transition-colors">
                  <a href="mailto:info@techavishkar.com" className="inline-flex items-center group">
                    info@techavishkar.com
                    <ExternalLink size={14} className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                  </a>
                </span>
              </div>
              <div className="flex items-start space-x-3 animate-fade-up" style={{ animationDelay: "0.2s" }}>
